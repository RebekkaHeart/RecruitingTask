...
- Deleted LogComponent.csproj and moved the LogComponent-folder into Application -> Couldn't see a reason for LogComponent to have its own project or folder when it is only used by Application's Program.cs
